...
> **PM-003 / Sprint 2** — owner: PM-3. Sibling docs: `positioning.md` (PM-1, buyer view), `launch-and-demo.md` (PM-2, launch GTM). This doc covers bottom-up developer adoption of the `cmd/mcpd` MCP surface.
