locals {
  ...
  app_environment = compact([
    ...
    "AGENT_COST_BUDGET_CENTS=${var.agent_cost_budget_cents}",
    "AGENT_PM_CALL_ESTIMATE_CENTS=${var.agent_pm_call_estimate_cents}",
    "AGENT_REVIEW_CALL_ESTIMATE_CENTS=${var.agent_review_call_estimate_cents}",
    "AUTO_BOT_BASELINE_MEETING_MINUTES=${var.auto_bot_baseline_meeting_minutes}",
